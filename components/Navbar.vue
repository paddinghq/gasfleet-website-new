...
<template>
  <nav class="lg:hidden">
    ...
    <div class="bg-white" :class="isMobileMenuOpen ? 'absolute w-screen h-screen z-10 opacity-100 transition-all duration-500' : 'absolute z-0 opacity-0 transition-all duration-500'">
