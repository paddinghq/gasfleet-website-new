<template>
  <div class="">
    <div class="relative bg-[#f1f1f1]">
      ...
      />
      <div
        class="text-white absolute top-[48%] left-[34%] transform -translate-x-1/2 -translate-y-1/2"
      >
        <h1 class="font-semibold mt-5 text-[4rem]">About Us</h1>
    ...
    <div class="p-16 flex gap-16">
      <div class="w-1/2 relative h-[28rem]">
        ...
        <NuxtImg
          class="w-[38rem] h-[25rem] absolute top-6 left-6"
          alt="frame"
          src="/Frame1.png"
        />
        <NuxtImg
          class="absolute w-[20rem] right-2 bottom-0"
          alt="rectangle"
          src="/Rectangle2.png"
        />
      </div>
      <div class="w-1/2 self-center">
        <h1 class="text-[#205FAD] font-semibold text-[2.5rem]">Our History</h1>
        <p class="text-[#0A0A0A] font-normal text-[1rem] mt-6">
    ...
    <div class="py-16 px-20">
      <div class="flex justify-center gap-5">
        <NuxtImg
          ...
          alt="line"
        />
        <h2 class="text-4xl text-[#205FAD] font-bold">Gasfleet Engineering</h2>
        <NuxtImg
          class="w-[30rem] h-[0.35rem] self-center"
          src="/Rectangle4.png"
          alt="line"
      ...
      <div class="flex gap-[10rem] mt-20">
        ...
        <div class="self-center">
          <h1 class="text-[#205FAD] font-bold text-[2.5rem]">Our Mission</h1>
      ...
      <div class="flex gap-[10rem] mt-12">
        ...
        <div class="self-center">
          <h1 class="text-[#205FAD] font-bold text-[2.5rem]">
            Our Core Values
          </h1>
          <p class="text-[#0A0A0A] mt-5 tracking-wide text-sm">
