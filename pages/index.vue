  ...
  <div>
    ...
    >
      ...
      >
        <div v-for="(item, index) in items" :key="index">
          ...
          <div
            class="relative h-[690px] top-[-46rem] pl-16 flex items-center bg-gradient-to-r from-black/80 via-black/60 to-transparent"
          >
            <div class="text-white flex flex-col gap-3">
              <h1 class="w-[45%] text-7xl">{{ item.title }}</h1>
              <p class="text-lg w-1/2">{{ item.text }}</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div>
      <div class="flex bg-white gap-10">
        <div class="">
          <img src="/image/services.png" alt="service" class="object-cover w-full h-full" />
        </div>
        
        <div class="p-20">
          <h1 class="text-[#205FAD] text-[40px] font-semibold">Our Services</h1>
          ...
          <div class="flex gap-4 items-center">
            <div class="bg-gray-100 p-4">
              ...
              <h2 class="uppercase font-semibold text-xl my-1">epcm</h2>
              <p>
            ...
            <div class="bg-gray-100 p-4">
              ...
              <h2 class="capitalize font-semibold text-xl my-1">
      ...
      <div class="bg-gray-100 py-20">
        <div class="container mx-auto flex bg-gray-100 gap-6">
          <div
            class="bg-[#205FAD] rounded-lg flex justify-between gap-6 flex-col py-10 px-6 text-white"
          >
            <h3 class="capitalize text-2xl font-semibold">Our Executed Projects</h3>
            <p class="text-justify w-96">
              We pride ourseleves on our commitment to safety and quality. We
              have a proven track record of delivering projects that meet or
              exceed industry standard, while also minimizing environmental
              impact and promoting the well being of our employees and the
              communities in which we operate
            </p>
            <button
              class="bg-white text-[#205FAD] text-center rounded-lg p-2 w-36 cursor-pointer transition-all hover:bg-gray-200"
            >
              <NuxtLink to="projects" class="text-sm">See all Projects</NuxtLink>
            </button>
          </div>
          ...
          <div class="flex flex-col">
            <div class="flex justify-between gap-6">
              <div class="flex flex-col gap-6">
                <img src="/image/project.png" alt="project" class="h-[269px]"/>
                <div class="">
                  <p class="font-semibold">Abuja gas fleet expansion</p>
      ...
      <div class="container mx-auto text-center bg-white my-16">
        <h2 class="font-bold text-5xl text-[#205FAD] capitalize">Our Client</h2>

        <div
          class="grid grid-cols-4 justify-center gap-5 items-center mt-16"
        >
